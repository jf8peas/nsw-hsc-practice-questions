 ...
 */
function short(n: number, formula: string, variable: string): ShortQuestion {
  return {
    id: `${U}.s${p2(n)}`,
    type: "short",
    formula,
 ...
 */
function mc(n: number, formula: string, canonical: [string, string, string, string]): McQuestion {
  const id = `${U}.m${p2(n)}`;
  return {
    id,
    type: "mc",
...
const shortQuestions: ShortQuestion[] = [
  ...
  short(2, "v² = u² + 2as", "v"),
  short(3, "v = u + at", "v"),
  short(4, "F_net = ma", "F_net"),
  short(5, "ΔU = mgΔh", "ΔU"),
  short(6, "W = Fs cos θ", "W"),
  short(7, "K = ½mv²", "K"),
  short(8, "P = ΔE / Δt", "P"),
  short(9, "P = Fv cos θ", "P"),
  short(10, "Σ½mv²(before) = Σ½mv²(after)", "v"),
  short(11, "Σmv(before) = Σmv(after)", "m"),
  short(12, "Δp = F_net Δt", "Δp"),
  short(13, "U = −GMm / r", "U"),
  short(14, "v = fλ", "λ"),
  short(15, "f = 1 / T", "T"),
  short(16, "n = c / v", "n"),
  short(17, "Q = mcΔT", "Q"),
  short(18, "f_beat = |f₂ − f₁|", "f_beat"),
  short(19, "f ′ = f (v_wave + v_observer) / (v_wave − v_source)", "f ′"),
  short(20, "n₁ sin θ₁ = n₂ sin θ₂", "θ₁"),
  short(21, "sin θ_c = n₂ / n₁", "θ_c"),
  short(22, "I₁r₁² = I₂r₂²", "I₁"),
  short(23, "Q / t = kAΔT / d", "k"),
  short(24, "E = V / d", "E"),
  short(25, "V = ΔU / q", "V"),
  short(26, "W = qV", "q"),
  short(27, "W = qEd", "E"),
  short(28, "B = μ₀I / 2πr", "B"),
  short(29, "F = qE", "F"),
  short(30, "F = (1 / 4πε₀)(q₁q₂ / r²)", "F"),
  short(31, "I = q / t", "I"),
  short(32, "V = IR", "R"),
  short(33, "P = VI", "P"),
  short(34, "F = qv⊥B = qvB sin θ", "F"),
  short(35, "F = lI⊥B = lIB sin θ", "F"),
  short(36, "F / l = (μ₀ / 2π)(I₁I₂ / r)", "F / l"),
  ...
  short(40, "F_net = ma", "m"),
  short(41, "ΔU = mgΔh", "Δh"),
  short(42, "W = Fs cos θ", "θ"),
  short(43, "K = ½mv²", "v"),
  short(44, "Q = mcΔT", "c"),
  short(45, "n₁ sin θ₁ = n₂ sin θ₂", "n₂"),
  short(46, "I₁r₁² = I₂r₂²", "r₁"),
  short(47, "B = μ₀I / 2πr", "r"),
  short(48, "F = (1 / 4πε₀)(q₁q₂ / r²)", "r"),
  short(49, "V = IR", "V"),
  short(50, "F = qvB sin θ", "B"),
];
...
const mcQuestions: McQuestion[] = [
  ...
  mc(19, "f ′ = f (v_wave + v_observer) / (v_wave − v_source)", [
  ...
  mc(44, "f ′ = f (v_wave + v_observer) / (v_wave − v_source)", [
